    ...
    <section id="services" className="bg-white mt-20 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {/* Service 1 */}
          <motion.div 
            className="feature-card bg-[#f8f9fa] p-6 rounded-lg shadow-lg border-t-4 border-[#1404c2]"
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              className="bg-[#f8f9fa] p-6 rounded-lg shadow-lg border-t-4 border-[#1404c2]"
              initial={{ y: 50, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.1 }}
            >
